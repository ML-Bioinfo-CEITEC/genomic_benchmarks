...
class GenomicClfDataset(Dataset):
    ...
    def __init__(self, dset_name, split, force_download=False, version=None, use_cloud_cache=False):
        """
        Parameters
            dset_name : str
...
def get_dataset(dataset_name, split, force_download=False, version=None, use_cloud_cache=False):
    return GenomicClfDataset(dataset_name, split, force_download, version, use_cloud_cache)


def DemoCodingVsIntergenomicSeqs(split, force_download=False, version=None, use_cloud_cache=False):
    return GenomicClfDataset("demo_coding_vs_intergenomic_seqs", split, force_download, version, use_cloud_cache)


def DemoHumanOrWorm(split, force_download=False, version=None, use_cloud_cache=False):
    return GenomicClfDataset("demo_human_or_worm", split, force_download, version, use_cloud_cache)


def DemoMouseEnhancers(split, force_download=False, version=None, use_cloud_cache=False):
    return GenomicClfDataset("dummy_mouse_enhancers_ensembl", split, force_download, version, use_cloud_cache)


def HumanEnhancersCohn(split, force_download=False, version=None, use_cloud_cache=False):
    return GenomicClfDataset("human_enhancers_cohn", split, force_download, version, use_cloud_cache)


def HumanEnhancersEnsembl(split, force_download=False, version=None, use_cloud_cache=False):
    return GenomicClfDataset("human_enhancers_ensembl", split, force_download, version, use_cloud_cache)


def HumanNontataPromoters(split, force_download=False, version=None, use_cloud_cache=False):
    return GenomicClfDataset("human_nontata_promoters", split, force_download, version, use_cloud_cache)

def HumanOcrEnsembl(split, force_download=False, version=None, use_cloud_cache=False):
